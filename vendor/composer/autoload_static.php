...
class ComposerStaticInit30fd7ec9b8e2598fd2f686f91346eea7
{
    public static $classMap = array (
        ...
        'yt\\request\\yt_multichannel' => __DIR__ . '/../..' . '/src/api/requests/yt_multichannel.php',
        'yt\\request\\yt_playlistitems' => __DIR__ . '/../..' . '/src/api/requests/yt_playlistitems.php',
        'yt\\request\\yt_playlists' => __DIR__ . '/../..' . '/src/api/requests/yt_playlists.php',
        'yt\\request\\yt_search' => __DIR__ . '/../..' . '/src/api/requests/yt_search.php',
        'yt\\request\\yt_subscriptions' => __DIR__ . '/../..' . '/src/api/requests/yt_subscriptions.php',
